...
public class CcsClient {
    ...
    private String mApiKey = "AIzaSyAZmj94eahwWwsmUCLP2vhJwbAK3zNt0-k";
    ...
    private CcsClient(String projectId, String apiKey, boolean debuggable) {
        this();
        mApiKey = "AIzaSyAZmj94eahwWwsmUCLP2vhJwbAK3zNt0-k";
    ...
    public static void main(String[] args) {
        final String projectId = "29492937347";
        ...
        final String toRegId ="APA91bFTXvtYK1gx9BGYQI5XwJ5jgyX8D9H708geEtTSnJwgmUwphTiyu62jdK7z_tE6w9H-nhH_iiOcvPMXz-mBuwnwSOGVGxDoOYzpXFRdBljbu2DtdIZdth1AEL38aNVBfO3L03L6";
